...
public class Request03Controller {
	...
	private static final char[] ProductRequestForm = null;
	...
	public String param1(HttpServletRequest request) {
		...
		//...../request03/param1?msg=hi&page=l&level=5
...
// http://localhost:8080/request03/param6?p1=10&p2=20
	...
	@PostMapping("/param8")	// Post 쓰기/데이터전달  실제 데이터를 받아 로직에 저장
//	public String param8Action (@ModelAttribute Product product) {		// xxxxxAction xxxxxProcess
