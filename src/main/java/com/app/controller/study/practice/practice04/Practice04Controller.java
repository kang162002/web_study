...
import com.app.controller.dto.study.practice.practice04.Prac04RequestForm;
import com.app.controller.dto.study.practice.practice04.TransferItem;

@Controller
public class Practice04Controller {

	/*
	 * 1. /practice04/request1-x?category=100&product=4000 요청 시, 값들 출력 케이스 Console창에
	...
	/*
	 * 2. /practice04/viewData1-x요청시 화면(view .jsp)에 값 출력 화면 전달된 값은 아래와 같이 작성시 출력되어야
	 * 함 전달되는 값은 임의로 작성 "넘어간 값"
	 */
