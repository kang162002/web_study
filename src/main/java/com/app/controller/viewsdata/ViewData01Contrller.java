package com.app.controller.viewsdata;
...
import com.app.controller.dto.study.Product;

@Controller
public class ViewData01Contrller {

	/*
	 * 
	 * FE --> BE 서버(Spring) ---> DB 와부 BE return "view이름" (html/css/js) <---view
	 * 자원(.jsp)
	 * 
	 */
...
//		String searchkeyword = request.getParameter("searchKeyword");
	 // String searchkeyword =  paramMap.get("serchKeyword");
